...
int parser_parse_symbol_multiply_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_MULTIPLY_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_divide_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_DIVIDE_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_modulo_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_MODULO_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_addition_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_ADDITION_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_subtraction_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_SUBTRACTION_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_left_shift_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_LEFT_SHIFT_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_right_shift_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_RIGHT_SHIFT_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_bitwise_and_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_BITWISE_AND_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_bitwise_xor_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_BITWISE_XOR_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_bitwise_or_assign(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_BITWISE_OR_ASSIGN))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_modulo(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_MODULO))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_increment(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_INCREMENT))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_decrement(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_DECREMENT))
	{
		l_index++;
	}
	else
...
int parser_parse_symbol_arrow(token_t *input_token_buffer, uintmax_t *input_token_buffer_size, object_t **output_object_buffer, uintmax_t *output_object_buffer_size, uintmax_t *index)
{
	...
	if(l_index < *input_token_buffer_size && input_token_buffer[l_index].token_type == TOKEN_TYPE_SYMBOL && (input_token_buffer[l_index].value.symbol == SYMBOL_ARROW))
	{
		l_index++;
	}
	else
...
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a translation unit!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an external declaration!\n");
	*index = l_index;
	return 0;
}
...
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a function definition!\n");
	*index = l_index;
	return 0;
lbl_failure:
	return -1;
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a declaration specifier!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a storage class specifier!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a type specifier!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a struct or union specifier!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a struct or union!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a struct declaration!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a specifier qualifier!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a struct declarator list!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a struct declarator!\n");
	*index = l_index;
	return 0;
}
...
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a declarator!\n");
	*index = l_index;
	return 0;
lbl_failure:
	return -1;
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a pointer!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a tyoe qualifier!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a direct declarator!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a direct declarator tail!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a constant expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a conditional expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a logical OR expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a logical AND expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an OR expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a XOR expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an AND expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an equality expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a relational expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a shift expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an additive expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a multiplicative expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a cast expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a unary expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a postfix expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a primary expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a constant!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an assignment expression!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an assignment operator!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a unary operator!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a type name!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a parameter type list!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a parameter declaration!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an abstract declarator!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a direct abstract declarator!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a direct abstract declarator tail!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an enum specifier!\n");
	*index = l_index;
	return 0;	
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an enumerator list!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an enumerator!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a typedef name!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a declaration!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an initializer declarator!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an initializer!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an initializer list!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a compound statement!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a statement!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "error: Successfully parsed a labeled statement!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an expression statement!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a selection statement!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an iteration statement!\n");
	*index = l_index;
	return 0;
}
...
lbl_failure:
	return -1;
lbl_success:
	fprintf(stderr, "debug: Successfully parsed a jump statement!\n");
	*index = l_index;
	return 0;
}
...
lbl_success:
	fprintf(stderr, "debug: Successfully parsed an identifier (identifier: `%.*s`)!\n", (int)input_token_buffer[l_index - 1].value.buffer_size, input_token_buffer[l_index - 1].value.string8_literal);
	*index = l_index;
	return 0;
lbl_failure:
	return -1;
