...
typedef enum
{
	...
	OBJECT_TYPE_SUFFIX_RULE_FUNCTION_DECLARATION = 0x04,
	...
	OBJECT_LITERAL_CHARACTER = (OBJECT_TYPE_PREFIX_LITERAL << 8) | OBJECT_TYPE_SUFFIX_CHARACTER_LITERAL,
	OBJECT_LITERAL_STRING = (OBJECT_TYPE_PREFIX_LITERAL << 8) | OBJECT_TYPE_SUFFIX_STRING_LITERAL,
	OBJECT_LITERAL_INTEGER = (OBJECT_TYPE_PREFIX_LITERAL << 8) | OBJECT_TYPE_SUFFIX_INTEGER_LITERAL,
	OBJECT_LITERAL_FLOAT = (OBJECT_TYPE_PREFIX_LITERAL << 8) | OBJECT_TYPE_SUFFIX_FLOAT_LITERAL,
