...
typedef enum
{
	...
	OBJECT_TYPE_SUFFIX_BITWISE_XOR_SYMBOL = 0x1D,
	OBJECT_TYPE_SUFFIX_BITWISE_NOT_SYMBOL = 0x1E,
	OBJECT_TYPE_SUFFIX_LEFT_PARENTHESIS_SYMBOL = 0x1F,
	OBJECT_TYPE_SUFFIX_RIGHT_PARENTHESIS_SYMBOL = 0x20,
	OBJECT_TYPE_SUFFIX_LEFT_BRACE_SYMBOL = 0x21,
	OBJECT_TYPE_SUFFIX_RIGHT_BRACE_SYMBOL = 0x22,
	OBJECT_TYPE_SUFFIX_LEFT_BRACKET_SYMBOL = 0x23,
	OBJECT_TYPE_SUFFIX_RIGHT_BRACKET_SYMBOL = 0x24,
	OBJECT_TYPE_SUFFIX_SEMICOLON_SYMBOL = 0x25,
	OBJECT_TYPE_SUFFIX_COMMA_SYMBOL = 0x26,
	OBJECT_TYPE_SUFFIX_PERIOD_SYMBOL = 0x27,
	OBJECT_TYPE_SUFFIX_MODULO_SYMBOL = 0x28,
	OBJECT_TYPE_SUFFIX_CONDITIONAL_SYMBOL = 0x29,
	OBJECT_TYPE_SUFFIX_COLON_SYMBOL = 0x2A,
	OBJECT_TYPE_SUFFIX_INCREMENT_SYMBOL = 0x2B,
	OBJECT_TYPE_SUFFIX_DECREMENT_SYMBOL = 0x2C,
	OBJECT_TYPE_SUFFIX_ARROW_SYMBOL = 0x2D,
